                     ...
                     <tr>
                        ...
                        <c:choose>
                           <c:when test="${client.status == 'Active'}">
                              ...
                              <input type="hidden" name="id" value="${client.id}">
                              <button title="View" name="operation" value="View" class="w3-btn w3-ripple w3-orange action"><i class="fa fa-eye fa_custom white"></i></button></form></td>
                              <td>
                                 <form action="ModifyClient" method="POST">
                                    <input type="hidden" name="id" value="${client.id}">
                                    <button title="Modify"name="operation" value="Search" class="w3-btn w3-ripple w3-blue action"><i class="fa fa-edit"></i></button>
                                 </form>
                              </td>
                              <form action="DeleteClient" method="POST">
                                 <td>
                                    <input type="hidden" name="id" value="${client.id}">
                                    <button title="Delete" name="operation" value="Delete" onClick="return confirm('Are you sure you want to delete this client?');" class="w3-btn w3-ripple w3-red action"><i class="fa fa-trash"></i></button>
                                 </td>
                              </form>
                           </c:when>
                           <c:otherwise>
                              ...
                              <td><button title="Modify" class="w3-btn w3-ripple w3-blue action disabled"><i class="fa fa-edit"></i></button></td><td><button title="Delete"class="w3-btn w3-ripple w3-red action disabled"><i class="fa fa-trash"></i></button></td>
                              </form>
                           </c:otherwise>
                        </c:choose>
                     </tr>
  ...
  <div id="id02" class="modal">
         <div class="modal-content animate">
            ...
            <div class="container" id="unscroll">
               <h2 class="center-sofia"> Modify Client Details </h2>
               <form:form action="updateClient" commandName="client" method="POST">
                            ...
                            <c:forEach items="${client.listOfAddresses}" varStatus="status" var="address">
                        <c:choose>
